...
console.log(
  `challenge variable has a length of ${challenge.length} characters`
);
...
const FANG = "Facebook, Google, Microsoft, Apple, IBM, Oracle, Amazon";
...
console.log("trimmed text of", challenge.trim(" "));
